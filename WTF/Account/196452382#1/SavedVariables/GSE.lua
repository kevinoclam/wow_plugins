...
GSELibrary = {
	...
	}, -- [3]
	{
		["PAPA_ASS_AOE"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence  reset=target/combat  Fan of Knives, Rupture, Fan of Knives, Envenom", -- [1]
					"/cast Fan of Knives", -- [2]
					"/cast Kingsbane", -- [3]
					"/cast Toxic Blade", -- [4]
					"/cast Garrote", -- [5]
					["Combat"] = true,
		...
		["PAPA_ASS"] = {
			...
			["MacroVersions"] = {
				{
					"/cast Garrote", -- [1]
					"/castsequence  reset=combat  Mutilate, Rupture, Mutilate, Envenom", -- [2]
					"/cast Kingsbane", -- [3]
					"/cast Toxic Blade", -- [4]
					"/castsequence  reset=combat  Mutilate, Envenom", -- [5]
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
						"/cast Vendetta", -- [1]
						"/cast [mod:alt] Poisoned Knife", -- [2]
					},
					["PostMacro"] = {
					},
					["PreMacro"] = {
	...
	}, -- [5]
	{
			...
			["MacroVersions"] = {
				{
					...
					"/castsequence Dark Transformation, Festering Strike, Outbreak", -- [2]
					"/castsequence Soul Reaper, Clawing Shadows, Outbreak", -- [3]
					"/cast Death Coil", -- [4]
					"/cast Summon Gargoyle", -- [5]
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
		...
		["HP_EX_Unholy_715"] = {
			...
			["MacroVersions"] = {
				{
					"/cast Scourge Strike", -- [1]
					"/castsequence Dark Transformation, Outbreak", -- [2]
					"/castsequence  reset=target  Festering Strike, Festering Strike", -- [3]
					"/castsequence  reset=target  Festering Strike, Festering Strike, Apocalypse", -- [4]
			...
			["MacroVersions"] = {
				{
					...
					"/cast Obliterate", -- [3]
					"/cast Frost Strike", -- [4]
					"/cast Howling Blast", -- [5]
					"/cast Obliterate", -- [6]
					"/cast Remorseless Winter", -- [7]
					"/cast Howling Blast", -- [8]
					"/cast Frost Strike", -- [9]
					"/cast Frost Strike", -- [10]
					"/cast Obliterate", -- [11]
					"/cast Frost Strike", -- [12]
					"/cast Remorseless Winter", -- [13]
					["LoopLimit"] = 13,
					["Combat"] = true,
					["StepFunction"] = "Sequential",
					["KeyRelease"] = {
					...
					["PreMacro"] = {
						"/cast Remorseless Winter", -- [1]
					},
					["KeyPress"] = {
						"/cast Obliteration", -- [1]
						"/cast Pillar of Frost", -- [2]
						"/cast Empower Rune Weapon", -- [3]
						"/cast Anti-Magic Shell", -- [4]
						"/cast [mod:alt] Obliterate", -- [5]
						"/cast [mod:ctrl] Howling Blast", -- [6]
						"/cast [mod:shift] Chains of Ice", -- [7]
					},
				}, -- [1]
			},
			["ManualIntervention"] = false,
			...
			["MacroVersions"] = {
				{
					...
					"/castsequence [nochanneling] Unstable Affliction, Reap Souls", -- [2]
					"/castsequence [nochanneling] reset=combat  Agony, Corruption, Drain Soul, Life Tap", -- [3]
					["KeyPress"] = {
						"/targetenemy [noharm][dead]", -- [1]
						"/use [mod:alt] Drain Soul", -- [2]
			...
			["MacroVersions"] = {
				{
					...
					["KeyPress"] = {
						...
						"/use [mod:alt] Drain Life", -- [5]
						"/castsequence  reset=target  Doom, null", -- [6]
					},
				}, -- [1]
			},
			["Icon"] = "INV_MISC_QUESTIONMARK",
			...
			["MacroVersions"] = {
				{
					...
					"/cast [nochanneling] Grimoire: Felguard", -- [5]
					"/cast [nochanneling] Command Demon", -- [6]
					"/cast [nochanneling] Demonbolt", -- [7]
					["KeyPress"] = {
						"/petautocastoff [group] Threatening Presence", -- [1]
